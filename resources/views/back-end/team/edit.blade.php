                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{url('admin/team/update/'.$member->id)}}" method="post"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="url" value="{{$member->url}}" class="form-control"
                                            id="" placeholder="Social Media URL">
                                    </div>
                                    <!-- SummerNote-->
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="description"
                                                id="summernote-editor">{{$member->description}}</textarea>
                                            </br>
