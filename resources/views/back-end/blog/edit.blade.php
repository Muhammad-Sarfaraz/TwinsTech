                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="sub-header">Edit Blog Post</p>
                            <form action="{{url('admin/blog/update/'.$post->id)}}" method="post" enctype="multipart/form-data">
                            @csrf  
                            @method('PUT')  
                            ...
                            <div class="form-row">
                                    ...
                                    <label for="" class="col-form-label">Title</label>
                                        <input type="text" name="title" class="form-control" value="{{$post->title}}" id="" placeholder="Title">
                                    </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea name="description"  id="summernote-editor">{!! $post->description !!}</textarea>
                                                </br>
